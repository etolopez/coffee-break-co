...
let AdminService = AdminService_1 = class AdminService {
    ...
    async updateSeller(sellerId, sellerData) {
        ...
        const updateData = {};
        if (sellerData.companyName !== undefined)
            updateData.companyName = sellerData.companyName;
        if (sellerData.companySize !== undefined)
            updateData.companySize = sellerData.companySize;
        if (sellerData.mission !== undefined)
            updateData.mission = sellerData.mission;
        if (sellerData.logo !== undefined)
            updateData.logo = sellerData.logo;
        if (sellerData.phone !== undefined)
            updateData.phone = sellerData.phone;
        if (sellerData.email !== undefined)
            updateData.email = sellerData.email;
        if (sellerData.location !== undefined)
            updateData.location = sellerData.location;
        if (sellerData.country !== undefined)
            updateData.country = sellerData.country;
        if (sellerData.city !== undefined)
            updateData.city = sellerData.city;
        if (sellerData.description !== undefined)
            updateData.description = sellerData.description;
        if (sellerData.website !== undefined)
            updateData.website = sellerData.website;
        if (sellerData.instagram !== undefined)
            updateData.instagram = sellerData.instagram;
        if (sellerData.facebook !== undefined)
            updateData.facebook = sellerData.facebook;
        if (sellerData.twitter !== undefined)
            updateData.twitter = sellerData.twitter;
        if (sellerData.certifications !== undefined)
            updateData.certifications = sellerData.certifications;
        if (sellerData.specialties !== undefined)
            updateData.specialties = sellerData.specialties;
        if (sellerData.defaultPricePerBag !== undefined)
            updateData.defaultPricePerBag = sellerData.defaultPricePerBag;
        if (sellerData.orderLink !== undefined)
            updateData.orderLink = sellerData.orderLink;
...
exports.AdminService = AdminService = AdminService_1 = tslib_1.__decorate([
